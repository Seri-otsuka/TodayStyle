<section>
    ...
    --}}
        ...
        <div class="flex flex-col  items-center pt-6 sm:pt-0 bg-gray-300">
            <!--入力ブロックの範囲-->
            <div class="w-full sm:max-w-xl mt-6 py-4 bg-gray-300 shadow-md overflow-hidden sm:rounded-lg">
                 <form method="POST" action="{{ route('register') }}">
                    ...
                    <!--ここで横並びにするようにしてるから五個並ぶ大きさで変換しているので、五個以上並べてしまうとサイズがおかしくなってしまいます。-->
                     ...
                     <!--キャミ-->
                         <div>
                            ...
                            <a
                                x-data=""
                                x-on:click.prevent="$dispatch('open-modal', 'upload-clothes-cyami')"
                            >
                            ...
                            <figure class="w-16 rounded-md bg-white pointer-events-auto indigo-500">
                                <x-modal name="upload-clothes-cyami" :show="$errors->userDeletion->isNotEmpty()" focusable>
                    ...
                    <div>
                        ...
                        <a
                            x-data=""
                            x-on:click.prevent="$dispatch('open-modal', 'upload-clothes-nosuribu')"
                        >
                        <figure class="w-16 rounded-md bg-white pointer-events-auto indigo-500">
                           <img class="w-16 rounded-md bg-white pointer-events-auto indigo-500" src="https://res.cloudinary.com/dlfimibcq/image/upload/v1702347922/icon_R_0294_ziqwci.png">
                            ...
                            <x-modal name="upload-clothes-nosuribu" :show="$errors->userDeletion->isNotEmpty()" focusable>
                                <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
                                    @csrf
                                    @method('delete')
